...
********* TODO Alt-backspace = ctrl-backspace :feat:
...
******** TODO [#C] Global "hyper+e" = emacs :feat:
...
******** TODO [#C] Port the shutdown mode :feat:
...
******** TODO [[https://github.com/hyprwm/Hyprland/issues/1250][Ultrawide config]] :feat:
...
******* TODO [#A] Check wireplumber config, adjust if does not work :2305:
******* Frame.work specific
:PROPERTIES:
...
** STRT [#A] 23.05 migration [0/3]

*** TODO Check all todos marked with 23.05 tag

*** TODO Check [[https://nixos.org/manual/nixos/stable/release-notes.html][what's new]] in 23.05

*** TODO Check all todos with high priority
...
** TODO Hyprland migration plan [7/8]
