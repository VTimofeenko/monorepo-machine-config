...
***** DONE Add other custom packages here :chore:
CLOSED: [2023-08-09 Wed 11:11]

***** TODO Add hyprland native notification for when custom tools fail :feat:
...
******** DONE [#C] Merge the default kitty.nix here :chore:
CLOSED: [2023-08-09 Wed 11:23]

******** TODO [#C] Make a portable SF color scheme :chore:
...
****** Vim
:PROPERTIES:
:header-args:nix+: :tangle homeManagerModules/vim/default.nix
:END:
...
******* DONE Add which-key :feat:
CLOSED: [2023-08-07 Mon 14:07]

******* DONE Add hmts for nested contained file syntax :feat:
CLOSED: [2023-08-22 Tue 13:11]
...
******* DONE Consider adding [[https://github.com/samwho/spacer][spacer]] :to_think:
CLOSED: [2023-08-08 Tue 12:59]
...
:PROPERTIES:
:header-args:nix+: :tangle nixosModules/hyprland-workspace-notifier/default.nix
:END:

Imported [[(workspace-import)][here]].
...
******* Ethernet
:PROPERTIES:
:header-args:nix+: :tangle modules/network/ethernet.nix
:END:
...
******* Public firewall
:PROPERTIES:
:header-args:nix+: :tangle modules/network/public-firewall.nix
:END:
...
******* Adhoc WiFi
:PROPERTIES:
:header-args:nix+: :tangle modules/network/adhoc-wifi.nix
:END:

Optionally importable module that configures adhoc WiFi.
...
******** Hyprland workspace notifier
:PROPERTIES:
:header-args:nix+: :tangle modules/hyprland/hyprland-workspace-notifier/default.nix
:END:

Imported [[(use-workspace-import))][here]].
...
******* DONE [#A] Add optional phone network commented :migration:
CLOSED: [2023-08-05 Sat 16:20]

******* Network selector
:PROPERTIES:
:header-args:nix+: :tangle modules/nixosSystems/uranium/network-selector.nix
:END:

A small module that merges the appropriate network config, based on the value of "network" option
...
This output contains all reusable home manager modules that are later dogfed into per-user and per-machine configurations.
