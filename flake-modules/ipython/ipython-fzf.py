"""Allows using fzf to search history."""
...
def is_in_empty_line(buf):
    """Whether the cursor is in an empty line."""
    text = buf.text
...
if getattr(ipython, "pt_app", None):
    ...
    registry.add_binding(Keys.ControlR, filter=(HasFocus(DEFAULT_BUFFER) & ~HasSelection()))(fzf_i_search)
